...
void initialise_premiers(void){
  ...
  premiers[_optTailleTableau_][ACCOLADE_OUVRANTE] = 1;
  ...
  premiers[_expression_][NON] = 1; // ! à verifier
  ...
  premiers[_expressionBis_][OU] = 1; // | à verifier
  
  premiers[_conjonction_][NON] = 1; // ! à verifier
  ...
  premiers[_comparaison_][NON] = 1; // ! à verifier
  ...
  premiers[_expArith_][NON] = 1; // ! à verifier
  ...
  premiers[_terme_][NON] = 1; // ! à verifier
  ...
  premiers[_negation_][NON] = 1; // ! à verifier
  ...
  premiers[_listeExpressions_][NON] = 1; // ! à verifier
